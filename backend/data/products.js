const products = [
  ...
  },
  {
    ...
    description:
      "We’ve engineered Chrome Tour X to provide outstanding distance, workability, and spin so you can experience your best performance from tee-to-green along with alignment-enhancing True Track Technology.",
    brand: "Golf Proshop",
    category: "Golf",
    price: 52,
    countInStock: 0,
  ...
  },
  {
    ...
    description:
      "Chrome Tour TruTrack is engineered for outstanding performance with exceptional speed, consistent flight, incredible spin, and greenside control. Plus, TruTrack combines the best elements of Truvis and Triple Track for enhanced roll feedback, visible spin, and alignment in a hi-vis Yellow ball.",
    brand: "Golf Proshop",
    category: "Golf",
    price: 52,
    countInStock: 10,
